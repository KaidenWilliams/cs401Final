...
# Import or define your BirdSpeciesDataset class here
...
def train_model(model, train_loader, val_loader, num_epochs=10, accumulation_steps=2):
    ...
    # Clear memory before starting (once is sufficient)
    gc.collect()
...
if __name__ == "__main__":
    ...
    with open(os.path.join(args.output_dir, 'species_mapping.json'), 'w') as f:
